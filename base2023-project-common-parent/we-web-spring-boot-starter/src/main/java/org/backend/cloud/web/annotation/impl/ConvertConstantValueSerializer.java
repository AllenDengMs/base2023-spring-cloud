...
import org.backend.cloud.web.utils.LanguageTool;
import org.backend.cloud.web.utils.SpringBeanTool;
import org.springframework.context.MessageSource;

@JacksonStdImpl
public class ConvertConstantValueSerializer extends JsonSerializer<Object> implements
    ContextualSerializer {

  private ConvertConstantValue asConstantLabel;
  ...
  public JsonSerializer<?> createContextual(SerializerProvider prov, BeanProperty beanProperty)
    ...
    asConstantLabel = beanProperty.getAnnotation(ConvertConstantValue.class);
    return this;
  }
}
